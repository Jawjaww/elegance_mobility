...
export function MobileNav() {
  ...
  return (
    <>
      {/* Bouton menu - Fond solide pour contraste */}
      <motion.button
        onClick={() => setIsOpen(true)}
        whileTap={{ scale: 0.92 }}
        className="fixed top-4 left-4 z-40 w-10 h-10 bg-neutral-900 rounded-full flex items-center justify-center border border-white/10 shadow-lg"
      >
