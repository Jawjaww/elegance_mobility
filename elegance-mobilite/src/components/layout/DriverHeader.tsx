...
export function DriverHeader() {
  ...
  // Hide top status bar on certain pages where it is redundant (e.g. setup)
  const hideTopBar = pathname === "/driver-portal/profile/setup";
  ...
  return (
    <>
      {/* Top Status Bar - Glassmorphism (hidden on pages where not needed) */}
      {!hideTopBar && (
