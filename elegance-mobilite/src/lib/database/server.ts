// // Server-side utilities for Supabase (used in API routes only)
// // Note: Not Server Actions - these functions run server-side in route handlers
...
//   from?: string | null,
// ) {
//   // ⚠️ FIX: Ne pas passer un objet { role } à getAppRole
//   // getAppRole attend un User avec app_metadata.role
//   // Ici on a déjà le rôle directement, pas besoin de getAppRole
//   const appRole = role || "app_customer"; // Fallback par défaut
...
//     if (
//       from === "admin" &&
//       ["app_admin", "app_super_admin"].includes(appRole || "")
//     ) {
