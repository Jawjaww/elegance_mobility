...
try {
  const users = [
    [
      "admin1@elegance-mobilite.local",
      "password123",
      "app_super_admin",
      "Admin",
      "Principal",
    ...
    [
      "admin2@elegance-mobilite.local",
      "password123",
      "app_admin",
      "Admin",
      "Secondaire",
    ...
    [
      "jean.dupont@elegance-mobilite.local",
      "password123",
      "app_driver",
      "Jean",
      "Dupont",
    ...
    [
      "marie.martin@elegance-mobilite.local",
      "password123",
      "app_driver",
      "Marie",
      "Martin",
    ...
    [
      "pierre.bernard@elegance-mobilite.local",
      "password123",
      "app_driver",
      "Pierre",
      "Bernard",
    ...
    [
      "client1@elegance-mobilite.local",
      "password123",
      "app_customer",
      "Client",
      "Un",
    ...
    [
      "client2@elegance-mobilite.local",
      "password123",
      "app_customer",
      "Client",
      "Deux",
