...
// Minimal, deterministic implementation compatible with Supabase local bundler.
// Uses absolute imports so Deno bundling works in the Supabase CLI environment.
// @ts-ignore
...
serve(async (req) => {
  try {
    ...
    // call DB RPC to check driver capability
